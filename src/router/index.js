...
export const asyncRoutes = [
    ...
    
    {
        ...
        children: [
            ...
            {
                path: 'poorVillage',
                redirect: '/issueList/poorVillage/index',
                ...
                children: [
                    {
                        path: 'index',
                        component: () => import('@/views/issue-list/poor-village/list'),
                        name: 'IssueListPoorVillageIndex',
                        hidden: true,
                        meta: {
                            title: '',
                            activeMenu: '/issueList/poorVillage',
                            noCache: true,
                            isShowSlideBar: true
                        }
                    },
                    {
                        path: 'detail',
                        component: () => import('@/views/issue-list/poor-village/detail'),
...
const createRouter = () => new Router({
    base: '/manage', // require service support
