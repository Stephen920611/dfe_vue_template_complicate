            ...
            <el-main style="padding: 10px;">
                <div class="text item">
                    ...
                    <div class="filter-container">
                        ...
                        <el-select class="filter-item" v-model="townValue" placeholder="请选择乡镇">
                            <el-option
                        ...
                        <el-select class="filter-item" v-model="villageValue" placeholder="请选择村">
                            <el-option
                        ...
                        <el-input v-model="listQuery.content" placeholder="请输入贫困户户主姓名" style="width: 200px;"
                                  class="filter-item" @keyup.enter.native="handleFilter"/>
                        <el-select class="filter-item" v-model="isProblemValue" placeholder="请选择是否有问题">
                            <el-option
                        ...
                        <el-select class="filter-item" v-model="householdsTypeValue" placeholder="贫困户类型">
                            <el-option
                        ...
                        <div style="float:right">
                            <!-- 下载按钮 -->
                            <el-button class="filter-item" style="margin-left: 10px;" type="primary"
                                       icon="el-icon-download" @click="handleDownload">Excel模板
                            </el-button>
                    ...
                    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row
                        ...
                        <!-- 操作 -->
                        <el-table-column label="问题详情" align="center" width="200"
