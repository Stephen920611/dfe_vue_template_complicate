        ...
        <div>
            <van-form  validate-first :scroll-to-error="true" :show-error="false">
                ...
                <van-cell>
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jba11=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jba12=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jba13=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jba14=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jba21=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jba22=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                ...
                <van-cell>
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jbb1=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jbb2=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jbb3=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jbb4=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jbb5=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jbb6=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jbb7=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                ...
                <van-cell title="c.金融扶贫政策落实情况"></van-cell>
                <van-cell>
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-if="form.jbc1 === '0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-if="form.jbc2 === '0'">
                            <van-field
                                    readonly
                                    rows="4"
                ...
                <van-cell title="d.孝善养老扶贫政策落实情况"></van-cell>
                <van-cell>
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-if="form.jbe1 === '0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-if="form.jbe2 === '0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-if="form.jbe3 === '0'">
                            <van-field
                                    readonly
                                    rows="4"
                ...
                <van-cell title="e.公益扶贫专岗政策落实情况"></van-cell>
                <van-cell>
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-if="form.jbf1 === '0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-if="form.jbf2 === '0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-if="form.jbf3 === '0'">
                            <van-field
                                    readonly
                                    rows="4"
                ...
                <van-cell>
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jbd1=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jbd2=='0'">
                            <van-field
                                    readonly
                                    rows="4"
