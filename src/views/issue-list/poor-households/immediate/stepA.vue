        ...
        <div>
            <van-form validate-first :scroll-to-error="true" :show-error="false">
                ...
                <van-cell>
                    <van-row class="margin-t-10">
                        ...
                        <van-col offset="1" span="9">
                            <van-field readonly v-model="form.jaa1" type="number" label="" placeholder="" style="padding:0 !important;"/>
                        </van-col>
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jaa2=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                ...
                <van-cell>
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jab11=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jab2=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                ...
                <van-cell>
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jac16=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jac11=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jac12=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22">
                            ...
                            <van-row>
                                <van-col offset="2" span="22" class="margin-t-10" v-show="form.jac121=='0'">
                                    <van-field
                                            readonly
                                            rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jac13=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jac14=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jac15=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jac21=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jac22=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jac23=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                    ...
                    <van-row>
                        <van-col offset="2" span="22" class="margin-t-10" v-show="form.jac3=='0'">
                            <van-field
                                    readonly
                                    rows="4"
                ...
                <van-cell>
                    ...
                    <van-col offset="2" span="22" class="margin-t-10" v-show="form.jad11=='0'">
                        <van-field
                                readonly
                                rows="4"
                    ...
                    <van-col offset="2" span="22" class="margin-t-10" v-show="form.jad12=='0'">
                        <van-field
                                readonly
                                rows="4"
                    ...
                    <van-col offset="2" span="22" class="margin-t-10" v-show="form.jad13=='0'">
                        <van-field
                                readonly
                                rows="4"
                    ...
                    <van-col offset="2" span="22" class="margin-t-10" v-show="form.jad14=='0'">
                        <van-field
                                readonly
                                rows="4"
                ...
                <van-cell>
                    ...
                    <van-col offset="2" span="22" class="margin-t-10" v-show="form.jae11=='0'">
                        <van-field
                                readonly
                                rows="4"
                    ...
                    <van-col offset="2" span="22" class="margin-t-10" v-show="form.jae12=='0'">
                        <van-field
                                readonly
                                rows="4"
                    ...
                    <van-col offset="2" span="22" class="margin-t-10" v-show="form.jae2=='0'">
                        <van-field
                                readonly
                                rows="4"
                    ...
                    <van-col offset="2" span="22" class="margin-t-10" v-show="form.jae3=='0'">
                        <van-field
                                readonly
                                rows="4"
                    ...
                    <van-col offset="2" span="22" class="margin-t-10" v-show="form.jae4=='0'">
                        <van-field
                                readonly
                                rows="4"
